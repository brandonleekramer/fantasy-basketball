...
select_data %>% 
  ...
  select(player, age, bbr_botb_fpts, bbr_botb_value_19,  
         botb_2019, botb_2020, botb_2021, botb_rfa, botb_gleague, botb_intl, bbr_botb_value_20, bbr_botb_value_21)
```
...
select_data %>% 
  ...
  filter(botb_team == "ZZZ") %>%
  filter(hta_botb_fpts > 18) %>% 
  #filter(age < 25) %>% 
  arrange(-hta_botb_value_19) %>% 
  select(player, age, hta_botb_fpts, hta_botb_value_19,  
         botb_2019, botb_2020, botb_2021, botb_rfa, botb_gleague, botb_intl, hta_botb_value_20, hta_botb_value_21)
```
...
select_data %>% 
  ...
  select(player, age, ht_botb_fpts, ht_botb_value_19,  
         botb_2019, botb_2020, botb_2021, botb_rfa, botb_gleague, botb_intl, ht_botb_value_20, ht_botb_value_21)
```
