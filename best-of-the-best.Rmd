...
select_data <- combined_data %>% 
  select(player, age,
         ...
         botb_rfa, botb_gleague, botb_intl, trade_comp)
...
select_data %>% 
  ...
  select(player, age, bbr_botb_fpts, hta_botb_fpts, ht_botb_fpts, botb_2019, botb_2020, botb_2021, botb_rfa, botb_gleague, botb_intl)
```
...
select_data %>% 
  ...
  select(player, age, bbr_botb_fpts, bbr_botb_value_19, bbr_botb_value_20, bbr_botb_value_21, 
         botb_2019, botb_2020, botb_2021, botb_rfa, botb_gleague, botb_intl)
```
...
select_data %>% 
  ...
  select(player, age, botb_team, bbr_botb_fpts, hta_botb_fpts, ht_botb_fpts, ht_botb_value_19, 
         botb_2019, botb_2020, botb_2021, botb_2022, botb_2023, botb_rfa, botb_gleague, botb_intl)
```
