...
select_data %>% 
  mutate(value20 = fr_fppg_ht / ld_2020 * 10000) %>%
  mutate(value21 = fr_fppg_ht / ld_2021 * 10000) %>%
  mutate(value20 = round(value20, 3)) %>% 
  ...
  select(player, value20, fntx_fppg, fr_fppg_ht, ld_2020, ld_2021)
```
