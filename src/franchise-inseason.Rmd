...
p <- select_data %>% 
  ...
  geom_point(color = dplyr::case_when(select_data$fr_team == "DEN" ~ "#ff4f00",
                                      TRUE ~ "#000000")) +
  geom_text_repel(data = subset(select_data, fr_team == "DEN"),
                  size = 4,
                  box.padding = 0.35, 
                  point.padding = 0.5,
                  force         = 100,
...
lm1 <- lm(fntx_fppg ~ fr_2019 + fr_2020 + fr_2021 + age, data = select_data)
lm1_resid <- resid(lm1)
qqnorm(lm1_resid, 
