...
gsd2_data %>% 
  ...
  mutate(y2021_22 = replace_na(y2021_22, 0),
  ...
  mutate(y2023_24 = ifelse(y2021_22 == 0 & proj_fppg > 49.99, proj_202122_cap*0.275, 
                    ...
                    ifelse(y2021_22 == 0 & proj_fppg > 09.99, proj_202122_cap*0.025, y2023_24)))))))))) %>% 
  mutate(y2022_23 = ifelse(y2021_22 == 0 & proj_fppg > 49.99, proj_202122_cap*0.275, 
                    ...
                    ifelse(y2021_22 == 0 & proj_fppg > 19.99, proj_202122_cap*0.100, 
                    ifelse(y2021_22 == 0 & proj_fppg > 14.99, proj_202122_cap*0.050, 
                    ifelse(y2021_22 == 0 & proj_fppg > 09.99, proj_202122_cap*0.025, y2022_23)))))))))) %>% 
  mutate(y2021_22 = ifelse(y2021_22 == 0 & proj_fppg > 49.99, proj_202122_cap*0.275, 
                    ...
                    ifelse(y2021_22 == 0 & proj_fppg > 19.99, proj_202122_cap*0.100, 
                    ifelse(y2021_22 == 0 & proj_fppg > 14.99, proj_202122_cap*0.050, 
                    ifelse(y2021_22 == 0 & proj_fppg > 09.99, proj_202122_cap*0.025, y2021_22)))))))))) %>% 
  ...
  mutate(y2024_25 = ifelse(y2022_23 == 0 & proj_fppg > 49.99, proj_202223_cap*0.275, 
                    ...
                    ifelse(y2022_23 == 0 & proj_fppg > 09.99, proj_202223_cap*0.025, y2024_25)))))))))) %>% 
  mutate(y2023_24 = ifelse(y2022_23 == 0 & proj_fppg > 49.99, proj_202223_cap*0.275, 
                    ...
                    ifelse(y2022_23 == 0 & proj_fppg > 19.99, proj_202223_cap*0.100, 
                    ifelse(y2022_23 == 0 & proj_fppg > 14.99, proj_202223_cap*0.050, 
                    ifelse(y2022_23 == 0 & proj_fppg > 09.99, proj_202223_cap*0.025, y2023_24)))))))))) %>% 
  mutate(y2022_23 = ifelse(y2022_23 == 0 & proj_fppg > 49.99, proj_202223_cap*0.275, 
                    ...
                    ifelse(y2022_23 == 0 & proj_fppg > 19.99, proj_202223_cap*0.100, 
                    ifelse(y2022_23 == 0 & proj_fppg > 14.99, proj_202223_cap*0.050, 
                    ifelse(y2022_23 == 0 & proj_fppg > 09.99, proj_202223_cap*0.025, y2022_23)))))))))) %>%
  mutate(value1yr = (gsd2_fppg_bbr / y2020_21) * 10000, 
         value2yr = (gsd2_fppg_bbr / y2020_21) + (gsd2_fppg_bbr / y2021_22)  * 10000,
         value3yr = (gsd2_fppg_bbr / y2020_21) + (gsd2_fppg_bbr / y2021_22) + (gsd2_fppg_bbr / y2022_23) * 10000) %>% 
  select(player, value1yr, value2yr, value3yr, y2020_21, y2021_22, y2022_23, y2023_24, y2024_25, gsd2_fppg_bbr, everything()) %>% 
  filter(gsd2_fppg_bbr > 30) %>% arrange(-value1yr) 
