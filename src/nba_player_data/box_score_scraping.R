# code taken from https://github.com/benduong1/Web-Scraping-NBA.com-for-Box-Score-Data/blob/master/Code%20to%20grab%20every%20season's%20box%20scores.R
...
# Creating a vector to house all the years of NBA data
